...
DataDir = "./res_data/xi_a_" + str(xi_a)  + "_xi_g_" + str(xi_g) +  "/"
...
model_tech3_post_damage = hjb_post_damage_post_tech(
        ...
        epsilon=1., fraction=.2,tol=1e-8, max_iter=4000, print_iteration=False)
...
res = hjb_pre_tech(
        ...
        V_post_damage=None,
        tol=1e-7, epsilon=0.1, fraction=0.01, smart_guess=None, max_iter=20000
        )
